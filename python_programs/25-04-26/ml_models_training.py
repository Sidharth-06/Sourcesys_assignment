...
class MLModelsTrainer:
    ...
    def train_linear_regression(self):
        ...
        # For linear regression, we'll predict one feature from others as a demo
        # Predicting 'petal_width' from other features
        X_train_lr = self.X_train[:, :3]  # sepal_length, sepal_width, petal_length
        X_test_lr = self.X_test[:, :3]
        y_train_lr = self.X_train[:, 3]   # petal_width
    ...
    def visualize_results(self):
        ...
        # 3. All metrics for Random Forest
...
if __name__ == "__main__":
    ...
    dataset_path = '../15-04-26/data/iris.csv'
